...
fruits=np.load('/Users/hongjo/PycharmProjects/pythonProject/fruits_300.npy')
print(fruits.shape)
...
apple_index=np.argsort(apple_mean)[:100] #np.argsort()는 작은 것에서 큰 순서대로 나열한 abs_mean 배열의 인덱스 반환
